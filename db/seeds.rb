...
lebron = User.create!({first_name: "LeBron", last_name: "James", email: "LebronJames@gmail.com", password: "123", pro_pic: ENV['Default1'], city: "Akron", state: "OH", realtor: false})
lebron.image.attach(io: File.open('app/assets/images/default-avatar.png'), filename: 'default-avatar.png', content_type: 'image/png')
yoan = User.create!({first_name: "Yoan ", last_name: "Ante", email: "YoanAnte@gmail.com", password: "123", pro_pic: ENV['Default2'], city: "New York", state: "NY", realtor: true})
selena = User.create!({first_name: "Selena ", last_name: "Gomez", email: "SelenaGomez@gmail.com", password: "123", pro_pic: ENV['Default3'], city: "Los Angeles", state: "CA", realtor: false})
...
kim = User.create!({first_name: "Kim ", last_name: "Kardashian", email: "KimKardashian@gmail.com", password: "123", pro_pic: ENV['Default5'], city: "Los Angeles", state: "CA", realtor: true})
tony = User.create!({first_name: "Tony ", last_name: "Soprano", email: "Tonysoprano@gmail.com", password: "123", pro_pic: ENV['Default6'], city: "Meadowlands", state: "NJ", realtor: false})

p "users seeded"

listing_one = Listing.create!({owner_id: lebron.id, price: 3300000, p_contact: "111-555-5555", address: "432 Park Ave", city: "New York", state: "NY", zipcode:"10010", neighborhood: "Midtown", features: "stainless steel fridge, wine bar", bed: 2, bath: 1, sqr_foot: 1200, default_image: [ENV['Aimg1'], ENV['Aimg2'], ENV['Aimg3'], ENV['Aimg4']], longitude: 40.7616, latitude: 73.9718 })
...
listing_six = Listing.create!({owner_id: tony.id, price: 1300000, p_contact: "666-555-5555", address: "1801 Ocean Ave", city: "Belmar", state: "NJ", zipcode: "07719", neighborhood: "Belmar", features: "kids playground, finished basement", bed: 7, bath: 6, sqr_foot: 7850, default_image: [ENV['Fimg1'], ENV['Fimg2'], ENV['Fimg3']], longitude: 40.1703, latitude: 74.0164 })
...
Comment.create(user_id: kim.id, listing_id: listing_four.id, content: 'cool test')
Comment.create(user_id: tony.id, listing_id: listing_three.id, content: 'fool test')
Comment.create(user_id: tony.id, listing_id: listing_three.id, content: 'drool test')
...
Comment.create(user_id: selena.id, listing_id: listing_six, content: 'tool test')
p "comments seeded"
